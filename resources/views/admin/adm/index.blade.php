...
@section('content')
    ...
    <modal nome="adicionar" titulo="Adcionar">
        <formulario id="formAdcionar" css="" method="post"
            action="{{ route('adm.store') }}" enctype="" token="{{ csrf_token() }}">
    ...
    <modal nome="editar" titulo="Editar">
        <formulario id="formEditar" css="" method="put" 
            ...
            <div class="form-group">
                <label for="admin">Admin</label>
                <select class="form-control" id="admin" name="admin" v-model="$store.state.item.autor" >
                    <option value="">Selecione</option>    
                    <option  
                        value="S">Sim</option>    
                    <option 
